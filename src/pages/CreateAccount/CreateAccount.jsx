...
const CreateAccount = () => {
  ...
  const dispatch = useDispatch()
	...
	return (
        ...
        {currentUser && <span className='text-green-400'>
        User successfully created</span>}
				<form onSubmit={e => handleSubmit(e)} action='submit' className='flex justify-center items-center flex-col gap-5 w-full'>
					<input
