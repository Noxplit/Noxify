		...
		<div className='w-full p-4 '>
			...
			<div className='flex flex-wrap  justify-around gap-4 items-center mb-4'>
				...
				<div className='flex justify-center items-center gap-4'>
					<button onClick={() => setPage(page - 1)} className='bg-purple-700 px-10 py-2 rounded-lg'>
						DOWN
					</button>
					<button onClick={() => setPage(page + 1)} className='bg-purple-700 px-12 py-2 rounded-lg'>
						UP
					</button>
				</div>
			...
			{loading ? (
				<div className='flex justify-center items-center m-10'>
					<BarLoader size={10} color='#a854f7' />
				</div>
			) : (
